      ...
      >
        ...
        <div className="hidden md:flex items-center gap-9">
          {links.map((l) => (
            ...
            >
              <span className="font-heading text-[10px] font-bold text-accent mr-1.5 tracking-[0.04em]">
                {l.num}
              </span>
              {l.label}
            </a>
        ...
        >
          ...
          <span className="w-[22px] h-0.5 bg-ink block rounded-[1px]" />
          <span className="w-3.5 h-0.5 bg-muted block rounded-[1px]" />
        </button>
      </nav>
        ...
        <div className="fixed inset-0 z-[190] bg-white/98 flex flex-col items-center justify-center gap-8">
          {links.map((l) => (
            <a
              ...
              className="font-heading text-[28px] font-bold text-navy transition-colors duration-200 hover:text-accent"
            >
              {l.label}
            </a>
          ))}
